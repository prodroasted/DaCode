...
public class TilmeldWindow extends Stage {
    ...
    public void initContent(GridPane pane){
        ...
        ChangeListener<Hotel> listener = (ov, oldHotel, newHotel) -> this.selectedHotelChange();
        ccbHotel.getSelectionModel().selectedItemProperty().addListener(listener);
    ...
    public void acceptAction () {
        ...
        if (navn.length() == 0 || adresse.length() == 0 || by.length() == 0 || land.length() == 0) {
            ...
            if (deltager != null) {
               ...
               if (cbLedsager.isSelected())
               Controller.createTilmelding(konference, cbFordragsholder.isSelected(), ankomstdato, afrejsedato, deltager, ledsager);
               else{
                   Controller.createTilmelding(konference, cbFordragsholder.isSelected(), ankomstdato, afrejsedato, deltager, null);
               }
           }

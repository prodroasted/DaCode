...
public class ArrayApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Aktuelt  : " + Arrays.toString(tabel));
        System.out.println(metode.findsum(metode.fyldArrayD()));
        System.out.println();
        ...
        System.out.println("Aktuelt  : " + Arrays.toString(tabel));
        System.out.println(metode.findsum(metode.fyldArrayF()));
        System.out.println();
        ...
        tabel = metode.AddsumArray(metode.fyldArrayD(), metode.fyldArrayF());
        System.out.println("Aktuelt : " + Arrays.toString(tabel));

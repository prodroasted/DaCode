package Studerende.studerendeopgave;
...
public class StudentGui extends Application {
	...
	private final Button btnFoeds = new Button("Fødselsdag");
	...
	private void initContent(GridPane pane) {
		...
		btnFoeds.setOnAction(event -> this.foedsAction());
